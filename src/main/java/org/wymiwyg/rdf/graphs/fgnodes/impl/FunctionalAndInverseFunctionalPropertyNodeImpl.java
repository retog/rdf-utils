 ...
 *
 */
public class FunctionalAndInverseFunctionalPropertyNodeImpl extends PropertyNodeImpl implements
		FunctionalPropertyNode, InverseFunctionalPropertyNode {

	/**
	 * @param uriRef
	 */
	public FunctionalAndInverseFunctionalPropertyNodeImpl(String uriRef) {
		super(uriRef);
	}
