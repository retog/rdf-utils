 ...
 *
 */
public interface PatchArguments extends GenericArguments {
	@CommandLine (
		longName ="inputModel",
		shortName = {"I"},
		required = true,
	...
	public File getInputModel();
	
	@CommandLine (
		longName ="targetModel",
		shortName = "T", 
		required = true,
	...
	@CommandLine (
			...
			shortName = "S", 
			required = true,
			description = "the location of the serialized diff to be used"
	)
