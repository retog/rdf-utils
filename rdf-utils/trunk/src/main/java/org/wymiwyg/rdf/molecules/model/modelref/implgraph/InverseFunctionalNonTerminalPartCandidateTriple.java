 ...
 *
 */
public class InverseFunctionalNonTerminalPartCandidateTriple extends NonTerminalPartCandidateTripleImpl  {
	 ...
	 * 
	 */
	public InverseFunctionalNonTerminalPartCandidateTriple(ModelRefGroundedNode subject, PropertyNode predicate, ModelRefGroundedNode object) {
		super(subject, predicate, object);
		this.afgn = subject;
		this.grounding = object;
	}
