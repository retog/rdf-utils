 ...
 *
 */
public class ModelRefTest extends TestCase {
	public void testSmallFoaf() {
		...
		assertEquals("Non Terminal Molecules count", 3, modelDec.getNonTerminalTriples().size());
		assertEquals("Terminal Molecules count", 0, modelDec.getNaturallyGroundedTriples().size());
	}
